...
void SYS_DMA_Channel0TransferAdd(void)
{
   ...
   PLIB_DMA_ChannelXDestinationStartAddressSet(DMA_ID_0, DMA_CHANNEL_0, (volatile unsigned long) &rb_buffer & 0x1FFFFFFF);
...
void SYS_DMA_Channel1TransferAdd(void)
{
   ...
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_1, (volatile unsigned long) &dumb_buffer & 0x1FFFFFFF);
